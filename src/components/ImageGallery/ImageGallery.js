  ...
  render() {
    ...
    return (
      <BannerAnim
        ...
        prefixCls={styles.custom_arrow_thumb}
      >
        <Element key="aaa"
        ...
        >
          ...
          />
          <TweenOne className={styles.banner_user_title} animation={{ y: 30, opacity: 0, type: 'from' }}>
            Ant Motion Banner
          </TweenOne>
          <TweenOne
            className={styles.banner_user_text}
        ...
        <Arrow arrowType="prev" key="prev" prefixCls={styles.user_arrow} component={TweenOne}
        ...
        >
          ...
          <TweenOneGroup
            ...
            leave={{ opacity: 0 }}
            appear={false}
            className={styles.img_wrapper} component="ul"
          >
            <li style={{ backgroundImage: `url(${this.imgArray[intArray[0]]})`}} key={intArray[0]} />
          </TweenOneGroup>
        </Arrow>
        <Arrow arrowType="next" key="next" prefixCls={styles.user_arrow} component={TweenOne}
        ...
        <Thumb prefixCls={styles.user_thumb} key="thumb" component={TweenOne}
